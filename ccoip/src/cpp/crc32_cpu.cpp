...
namespace ccoip::hash_utils {
    namespace {
        ...
        //------------------------------------------------------------------//
        // 3) Provide specialized implementations as separate functions
        //------------------------------------------------------------------//
        ...
        //------------------------------------------------------------------//
        // 4) Provide a one-time initialization and global dispatcher
        //------------------------------------------------------------------//
...
void _SpoofCpuFeatures(const CPUFeatures &cpu_features) {
    // Ensure we only do CPU feature detection once
    std::call_once(ccoip::hash_utils::g_initOnce, ccoip::hash_utils::initBestCrc32);
    ccoip::hash_utils::switchCrc32Kernels(cpu_features);
}
